 ...
 * 5 minutes; tapping hides the current message until a different one is set.
...
export function MaintenanceBanner() {
  ...
  const { data } = useQuery({ queryKey: ['system-status'], queryFn: fetchSystemStatus, refetchInterval: 5 * 60_000, retry: false })
